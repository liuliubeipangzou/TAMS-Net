...
# Resume and init
config.resume = True
config.resume_step = 599111
config.init = False
config.init_model = "/d9lab/tulei/SwinFace/output"

# Step num
config.warmup_step = 0
config.total_step = 30000
...
config.analysis_loss_weights = [1.0, 0.5, 1.0, 1.2]
...
config.output = "/d9lab/tulei/SwinFace/train/output1" ####Path for Output

config.verbose = 500
config.save_verbose = 1000
config.frequent = 20
